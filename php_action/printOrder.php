...
$sql = "SELECT orderDate, clientName, clientContact, subTotal, gstn, totalAmount, discount, grandTotalValue, paid, dueValue, paymentPlace,gstn FROM orders WHERE id = $orderId";
...
$paid = $orderData[8];
$dueValue = $orderData[9];
$paymentPlace = $orderData[10];
$gstn = $orderData[11];


$orderItemSql = "SELECT order_item.productName, order_item.rate, order_item.quantity, order_item.total,
                  ...
                  <tr>
                     <td colspan="3" style="border-left: 1px solid black;padding-left: 5px;border-right: 1px solid black;">
                        * Intrest will be charged upon all acounts 
                        <p style="margin: 0px;">remaning unpaid after dueValue date</p>
                     </td>
                  </tr>
               </tbody>
            </table>';
