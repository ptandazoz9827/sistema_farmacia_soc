...
$sql = "SELECT id, orderDate, clientName, clientContact, paymentStatus FROM orders WHERE delete_status = 0";
...
if($result->num_rows > 0) { 
 ...
 while($row = $result->fetch_array()) {
 	...
 	$countOrderItemSql = "SELECT count(*) FROM order_item WHERE lastid = $orderId";
