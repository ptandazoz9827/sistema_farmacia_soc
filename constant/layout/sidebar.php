 ...
 <div class="left-sidebar">
     ...
     <div class="scroll-sidebar">
         ...
         <nav class="sidebar-nav">
             ...
             <!-- Insertar dentro del menu lateral existente de constant/layout/sidebar.php -->
<li class="nav-label">Seguridad</li>
<li><a href="security_dashboard.php"><i class="fa fa-shield"></i><span>Dashboard Security</span></a></li>
<li><a href="security_events.php"><i class="fa fa-list"></i><span>Eventos</span></a></li>
<li><a href="security_incidents.php"><i class="fa fa-exclamation-triangle"></i><span>Incidentes</span></a></li>
<li><a href="security_osint.php"><i class="fa fa-search"></i><span>Inteligencia OSINT</span></a></li>
</ul>
         </nav>
